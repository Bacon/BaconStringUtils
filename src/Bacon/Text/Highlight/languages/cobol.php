    ...
    'keywords' => array(
        array(
            ...
            'list' => array(
                ...
                'areas', 'ascending', 'assign', 'at', 'author', 'before',
                'binary', 'blank', 'block', 'bottom', 'by', 'call', 'cancel',
                'cd', 'cf', 'ch', 'character', 'characters', 'class',
                'clock-units', 'close', 'cobol', 'code', 'code-set',
                'collating', 'column', 'comma', 'common', 'communication',
                'comp', 'comp-0', 'comp-1', 'comp-2', 'comp-3', 'comp-4',
                'comp-5', 'comp-6', 'comp-x', 'computational',
                'computational-0', 'computational-1', 'computational-2',
                ...
                'control-area', 'controls', 'converting', 'copy', 'corr',
                'corresponding', 'count', 'currency', 'data', 'date',
                ...
                'decimal-point', 'declaratives', 'delete', 'delimited',
                'delimiter', 'depending', 'descending', 'destination', 'detail',
                'disable', 'display', 'divide', 'division', 'down',
                'duplicates', 'dynamic', 'egi', 'else', 'emi', 'enable', 'end',
                ...
                'enter', 'environment', 'eop', 'equal', 'error', 'esi',
                'evaluate', 'every', 'exception', 'exit', 'extend', 'external',
                'false', 'fd', 'file', 'file-control', 'filler', 'final',
                'first', 'footing', 'for', 'from', 'function', 'generate',
                'giving', 'global', 'go', 'greater', 'group', 'heading',
                ...
                'inspect', 'installation', 'into', 'invalid', 'just',
                'justified', 'key', 'label', 'last', 'leading', 'left',
                'length', 'less', 'limit', 'limits', 'linage', 'linage-counter',
                'line', 'line-counter', 'lines', 'linkage', 'lock', 'low-value',
                'low-values', 'memory', 'merge', 'message', 'mode', 'modules',
                'more-labels', 'move', 'multiple', 'multiply', 'native',
                'negative', 'next', 'no', 'not', 'number', 'numeric',
                'numeric-edited', 'object-computer', 'occurs', 'of', 'off',
                ...
                'picture', 'plus', 'pointer', 'position', 'positive',
                'printing', 'procedure', 'procedures', 'proceed', 'program',
                'program-id', 'purge', 'queue', 'quote', 'quotes', 'random',
                'rd', 'read', 'receive', 'record', 'records', 'redefines',
                'reel', 'reference', 'references', 'relative', 'release',
                'remainder', 'removal', 'renames', 'replace', 'replacing',
                'report', 'reporting', 'reports', 'rerun', 'reserve', 'return',
                'reversed', 'rewind', 'rewrite', 'rf', 'rh', 'right', 'rounded',
                'run', 'same', 'sd', 'search', 'section', 'security', 'segment',
                ...
                'sub-queue-2', 'sub-queue-3', 'subtract', 'sum', 'super',
                'suppress', 'symbolic', 'sync', 'synchronized', 'tallying',
                'tape', 'terminal', 'terminate', 'test', 'text', 'than', 'then',
                'through', 'thru', 'time', 'times', 'to', 'top', 'trailing',
                'true', 'type', 'unit', 'unstring', 'until', 'up', 'upon',
                'usage', 'use', 'using', 'value', 'values', 'varying', 'when',
                'with', 'words', 'working-storage', 'write', 'zero', 'zeroes',
            ),
        ),
    ),
    'comments' => array(
