...
return array(
    ...
    'keywords' => array(
        array(
            'id' => 1,
            'list' => array(
                'abort', 'abs', 'absent', 'absolute', 'access', 'according',
                'action', 'ada', 'add', 'admin', 'after', 'aggregate', 'alias',
                'all', 'allocate', 'also', 'alter', 'always', 'analyse',
                'analyze', 'and', 'any', 'are', 'array', 'array_agg', 'as',
                'asc', 'asensitive', 'assertion', 'assignment', 'asymmetric',
                'at', 'atomic', 'attribute', 'attributes', 'authorization',
                'avg', 'backward', 'base64', 'before', 'begin', 'bernoulli',
                'between', 'binary', 'bit', 'bitvar', 'bit_length', 'blob',
                'blocked', 'bom', 'both', 'breadth', 'by', 'cache', 'call',
                ...
                'comments', 'commit', 'committed', 'completion', 'concurrently',
                'condition', 'condition_number', 'configuration', 'connect',
                'connection', 'connection_name', 'constraint', 'constraints',
                'constraint_catalog', 'constraint_name', 'constraint_schema',
                'constructor', 'contains', 'content', 'continue', 'control',
                'conversion', 'convert', 'copy', 'corr', 'corresponding',
                'cost', 'count', 'covar_pop', 'covar_samp', 'create',
                ...
                'database', 'datalink', 'datetime_interval_code',
                ...
                'disable', 'discard', 'disconnect', 'dispatch', 'distinct',
                'dlnewcopy', 'dlpreviouscopy', 'dlurlcomplete',
                'dlurlcompleteonly', 'dlurlcompletewrite', 'dlurlpath',
                'dlurlpathonly', 'dlurlpathwrite', 'dlurlscheme', 'dlurlserver',
                'dlvalue', 'do', 'document', 'domain', 'double', 'drop',
                'dynamic', 'dynamic_function', 'dynamic_function_code', 'each',
                'element', 'else', 'empty', 'enable', 'encoding', 'encrypted',
                'end', 'end-exec', 'enum', 'equals', 'escape', 'every',
                'except', 'exception', 'exclude', 'excluding', 'exclusive',
                'exec', 'execute', 'existing', 'exists', 'exp', 'explain',
                'external', 'extract', 'false', 'family', 'fetch', 'file',
                'filter', 'final', 'first', 'first_value', 'flag', 'floor',
                'following', 'for', 'force', 'foreign', 'fortran', 'forward',
                'found', 'free', 'freeze', 'from', 'fs', 'full', 'function',
                'functions', 'fusion', 'general', 'generated', 'get', 'global',
                'go', 'goto', 'grant', 'granted', 'greatest', 'group',
                'grouping', 'handler', 'having', 'header', 'hex', 'hierarchy',
                'hold', 'host', 'hour', 'id', 'identity', 'if', 'ignore',
                'ilike', 'immediate', 'immutable', 'implementation', 'implicit',
                'import', 'in', 'including', 'increment', 'indent', 'index',
                'indexes', 'indicator', 'infix', 'inherit', 'inherits',
                'initialize', 'initially', 'inline', 'inner', 'inout', 'input',
                'insensitive', 'insert', 'instance', 'instantiable', 'instead',
                'integrity', 'intersect', 'intersection', 'interval', 'into',
                'invoker', 'is', 'isnull', 'isolation', 'iterate', 'join',
                'key', 'key_member', 'key_type', 'lag', 'language', 'large',
                'last', 'last_value', 'lateral', 'lc_collate', 'lc_ctype',
                'lead', 'leading', 'least', 'left', 'length', 'less', 'level',
                'library', 'like', 'like_regex', 'limit', 'link', 'listen',
                'ln', 'load', 'local', 'localtime', 'localtimestamp',
                'location', 'locator', 'lock', 'login', 'lower', 'map',
                'mapping', 'match', 'matched', 'max', 'maxvalue',
                ...
                'names', 'namespace', 'national', 'natural', 'nchar', 'nclob',
                'nesting', 'new', 'next', 'nfc', 'nfd', 'nfkc', 'nfkd', 'nil',
                'no', 'nocreatedb', 'nocreaterole', 'nocreateuser', 'noinherit',
                'nologin', 'none', 'normalize', 'normalized', 'nosuperuser',
                'not', 'nothing', 'notify', 'notnull', 'nowait', 'nth_value',
                'ntile', 'null', 'nullable', 'nullif', 'nulls', 'numeric',
                'object', 'occurrences_regex', 'octets', 'octet_length', 'of',
                'off', 'offset', 'oids', 'old', 'on', 'only', 'open',
                'operation', 'operator', 'option', 'options', 'or', 'order',
                ...
                'parameter_specific_schema', 'parser', 'partial', 'partition',
                'pascal', 'passing', 'passthrough', 'password', 'path',
                ...
                'public', 'quote', 'range', 'rank', 'read', 'reads', 'real',
                ...
                'returning', 'returns', 'revoke', 'right', 'role', 'rollback',
                'rollup', 'routine', 'routine_catalog', 'routine_name',
                'routine_schema', 'row', 'rows', 'row_count', 'row_number',
                'rule', 'savepoint', 'scale', 'schema', 'schema_name', 'scope',
                ...
                'similar', 'simple', 'size', 'smallint', 'some', 'source',
                ...
                'stdout', 'storage', 'strict', 'strip', 'structure', 'style',
                'subclass_origin', 'sublist', 'submultiset', 'substring',
                'substring_regex', 'sum', 'superuser', 'symmetric', 'sysid',
                'system', 'system_user', 'table', 'tables', 'tablesample',
                ...
                'unbounded', 'uncommitted', 'under', 'unencrypted', 'union',
                'unique', 'unknown', 'unlink', 'unlisten', 'unnamed', 'unnest',
                'until', 'untyped', 'update', 'upper', 'uri', 'usage', 'user',
                'user_defined_type_catalog', 'user_defined_type_code',
                'user_defined_type_name', 'user_defined_type_schema', 'using',
                'vacuum', 'valid', 'validator', 'value', 'values', 'varbinary',
                'variable', 'variadic', 'varying', 'var_pop', 'var_samp',
                'verbose', 'version', 'view', 'volatile', 'when', 'whenever',
                'where', 'whitespace', 'width_bucket', 'window', 'with',
                'within', 'without', 'work', 'wrapper', 'write', 'xml',
                'xmlagg', 'xmlattributes', 'xmlbinary', 'xmlcast', 'xmlcomment',
        ...
        array(
            'id' => 2,
            'list' => array(
                'boolean', 'char', 'character', 'date', 'float', 'integer',
                'int', 'long', 'mlslabel', 'number', 'raw', 'rowid', 'varchar',
            ),
        ),
        array(
            'id' => 3,
