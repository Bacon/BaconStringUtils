    ...
    'keywords' => array(
        array(
            ...
            'list' => array(
                ...
                'bit', 'body', 'break', 'byte', '', 'case', 'cast', 'catch',
                'cdouble', 'cent', 'cfloat', 'char', 'class', 'const',
                'continue', 'creal', 'dchar', 'debug', 'default', 'delegate',
                'delete', 'deprecated', 'do', 'double', '', 'else', 'enum',
                'export', 'extern', '', 'false', 'final', 'finally', 'float',
                'for', 'foreach', 'function', '', 'goto', 'idouble', 'if',
                'ifloat', 'import', 'in', 'inout', 'int', 'interface',
                'invariant', 'ireal', 'is', '', 'long', '', 'mixin', 'module',
                '', 'new', 'null', '', 'out', 'override', '', 'package',
                'pragma', 'private', 'protected', 'public', '', 'real',
                'return', '', 'short', 'static', 'struct', 'super', 'switch',
                'synchronized', '', 'template', 'this', 'throw', 'true', 'try',
                'typedef', 'typeid', 'typeof', '', 'ubyte', 'ucent', 'uint',
        ...
        array(
            ...
            'list' => array(
                ...
                'addsd', 'addss', '', 'and', 'andnpd', 'andnps', 'andpd',
                'andps', '', 'arpl', 'bound', 'bsf', 'bsr', 'bswap', '', 'bt',
                'btc', 'btr', 'bts', 'call', '', 'cbw', 'cdq', 'clc', 'cld',
                'clflush', '', 'cli', 'clts', 'cmc', 'cmova', 'cmovae', '',
                ...
                'cmovp', 'cmovpe', '', 'cmovpo', 'cmovs', 'cmovz', 'cmp',
                'cmppd', '', 'cmpps', 'cmps', 'cmpsb', 'cmpsd', 'cmpss', '',
                'cmpsw', 'cmpxch8b', 'cmpxchg', 'comisd', 'comiss', '', 'cpuid',
                ...
                'daa', 'das', 'db', 'dd', '', 'de', 'dec', 'df', 'di', 'div',
                '', 'divpd', 'divps', 'divsd', 'divss', 'dl', '', 'dq', 'ds',
                'dt', 'dw', 'emms', '', 'enter', 'f2xm1', 'fabs', 'fadd',
                'faddp', '', 'fbld', 'fbstp', 'fchs', 'fclex', 'fcmovb', '',
                ...
                'fucom', 'fucomi', 'fucomip', '', 'fucomp', 'fucompp', 'fwait',
                'fxam', 'fxch', '', 'fxrstor', 'fxsave', 'fxtract', 'fyl2x',
                'fyl2xp1', '', 'hlt', 'idiv', 'imul', 'in', 'inc', '', 'ins',
                'insb', 'insd', 'insw', 'int', '', 'into', 'invd', 'invlpg',
                'iret', 'iretd', '', 'ja', 'jae', 'jb', 'jbe', 'jc', '', 'jcxz',
                'je', 'jecxz', 'jg', 'jge', '', 'jl', 'jle', 'jmp', 'jna',
                'jnae', 'jnb', 'jnbe', 'jnc', 'jne', 'jng', '', 'jnge', 'jnl',
                'jnle', 'jno', 'jnp', '', 'jns', 'jnz', 'jo', 'jp', 'jpe', '',
                'jpo', 'js', 'jz', 'lahf', 'lar', '', 'ldmxcsr', 'lds', 'lea',
                'leave', 'les', 'lfence', 'lfs', 'lgdt', 'lgs', 'lidt', '',
                ...
                'movlpd', 'movlps', 'movmskpd', '', 'movmskps', 'movntdq',
                'movnti', 'movntpd', 'movntps', '', 'movntq', 'movq', 'movq2dq',
                'movs', 'movsb', '', 'movsd', 'movss', 'movsw', 'movsx',
                'movupd', '', 'movups', 'movzx', 'mul', 'mulpd', 'mulps', '',
                'mulsd', 'mulss', 'neg', 'nop', 'not', '', 'or', 'orpd', 'orps',
                'out', 'outs', '', 'outsb', 'outsd', 'outsw', 'packssdw',
                'packsswb', '', 'packuswb', 'paddb', 'paddd', 'paddq', 'paddsb',
                '', 'paddsw', 'paddusb', 'paddusw', 'paddw', 'pand', '',
                'pandn', 'pavgb', 'pavgw', 'pcmpeqb', 'pcmpeqd', '', 'pcmpeqw',
                'pcmpgtb', 'pcmpgtd', 'pcmpgtw', 'pextrw', '', 'pinsrw',
                'pmaddwd', 'pmaxsw', 'pmaxub', 'pminsw', '', 'pminub',
                'pmovmskb', 'pmulhuw', 'pmulhw', 'pmullw', '', 'pmuludq', 'pop',
                'popa', 'popad', 'popf', '', 'popfd', 'por', 'prefetchnta',
                'prefetcht0', 'prefetcht1', '', 'prefetcht2', 'psadbw',
                ...
                'pushad', '', 'pushf', 'pushfd', 'pxor', 'rcl', 'rcpps', '',
                'rcpss', 'rcr', 'rdmsr', 'rdpmc', 'rdtsc', '', 'rep', 'repe',
                'repne', 'repnz', 'repz', '', 'ret', 'retf', 'rol', 'ror',
                'rsm', '', 'rsqrtps', 'rsqrtss', 'sahf', 'sal', 'sar', '',
                'sbb', 'scas', 'scasb', 'scasd', 'scasw', '', 'seta', 'setae',
                ...
                'setz', '', 'sfence', 'sgdt', 'shl', 'shld', 'shr', '', 'shrd',
                'shufpd', 'shufps', 'sidt', 'sldt', '', 'smsw', 'sqrtpd',
                'sqrtps', 'sqrtsd', 'sqrtss', '', 'stc', 'sti', 'stmxcsr',
                'stos', '', 'stosb', 'stosd', 'stosw', 'str', 'sub', '',
                'subpd', 'subps', 'subsd', 'subss', 'sysenter', '', 'sysexit',
                'test', 'ucomisd', 'ucomiss', 'ud2', '', 'unpckhpd', 'unpckhps',
                'unpcklpd', 'unpcklps', 'verr', 'verw', 'wait', 'wbinvd',
                'wrmsr', 'xadd', 'xchg', 'xlat', 'xlatb', 'xor', 'xorpd',
                'xorps', 'addsubpd', 'addsubps', 'fisttp', 'haddpd', 'haddps',
                'hsubpd', 'hsubps', 'lddqu', 'monitor', 'movddup', 'movshdup',
                'movsldup', 'mwait', 'pavgusb', 'pf2id', 'pfacc', 'pfadd',
